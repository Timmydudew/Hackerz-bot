...
var vtalk_dsc = ''
var reply_eva = ''
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to Hackerz bot voice chat.', reply_eva = '*Reply to Any Voice Message! Pls*'
...
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional Hackerz bot features. Turn your account into a ai chatbot!'
    already_on = 'Hackerz bot artificial intelligence is already fully functional.'
    already_off = 'Hackerz bot artificial intelligence is currently running semi-functional.'
    succ_on = 'Hackerz bot Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'Hackerz bot Set to Semi-Functional! Please wait a bit! ☑️'
}
